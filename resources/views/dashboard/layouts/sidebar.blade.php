<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    ...
    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
        ...
        <ul class="nav flex-column mb-auto" style="height: 100vh">
        {{-- <li class="nav-item">
        ...
        <form action="/logout" method="post">
            @csrf
            <button type="submit" class="nav-link d-flex align-items-center gap-2"><svg class="bi"><use xlink:href="#door-closed"/></svg></i> Logout</button>
        </form>
        </li>
        </ul>
    </div>
